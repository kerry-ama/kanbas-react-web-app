    ...
    <input type="checkbox" id="wd-assignment-completed"
      ...
      <a id="wd-retrieve-assignment-score" className="btn btn-primary me-2"
       href={`${REMOTE_SERVER}/lab5/assignment/score`}>
        ...
        <a id="wd-retreive-assignment-completed" className="btn btn-success" 
            href={`${REMOTE_SERVER}/lab5/assignment/completed`}>
                Get Completed Status
            </a>
        <hr/>
      <h4>Modifying Properties - Module</h4>
      <a id="wd-update-module-name mb-2"
      ...
      <a id="id-retreive-assignment-description" className="btn btn-success"
