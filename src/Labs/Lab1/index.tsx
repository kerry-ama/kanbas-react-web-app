            ...
            <div id="wd-h-tag">
                ...
                <div id="wd-tables">
                    ...
                    <table border={1} width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Q7</td>
                                <td>Node Web Server REST APIs</td>
                                <td>3/16/21</td>
                                <td>99</td>
                            </tr>
                            <tr>
                ...
                <div id="wd-forms">
                    ...
                    <form id="wd-text-fields">
                        ...
                        <input type="radio" name="radio-genre" id="wd-radio-romcom" />
                        <label htmlFor="wd-radio-romcom">Romantic Comedy</label>
                        ...
                        <input type="checkbox" name="check-genre" id="ed-chkbox-romcom" />
                        <label htmlFor="wd-chkbox-romcom">Romantic Comedy</label>
                ...
                <div>
                    ...
                    Please <a id="wd-github" href="https://github.com/kerry-ama/kanbas-react-web-app"> click here </a>to navigate to the code repository in github<br />
                </div>
