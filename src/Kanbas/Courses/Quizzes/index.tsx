                            ...
                            .map((quiz: any) => (
                                <li className="wd-assignment-list-item list-group-item p-3 ps-1">
                                    <div>
                                        ...
                                        <Link to={`/Kanbas/Courses/${cid}/Quizzes/${quiz._id}`} className="wd-assignment-link text-danger multiple-modules-link" >
                                            Multiple Modules
                                        </Link>  | <strong>Not available until</strong> {formatDate(quiz.availability)} | <QuizControlButtons /><br />
                                        <div className="indented-text"><strong>Due</strong> {formatDate(quiz.due)} | {quiz.points} pts</div>
